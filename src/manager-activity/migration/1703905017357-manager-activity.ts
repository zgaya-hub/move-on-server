...
export class ManagerActivity1703905017357 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`manager_activity\` ADD CONSTRAINT \`FK_92fc71aeb2ad7c46577fa31d963\` FOREIGN KEY (\`manager_id\`) REFERENCES \`manager\`(\`ID\`) ON DELETE CASCADE ON UPDATE NO ACTION`);
    }
