...
export class MediaBasicInfo1699555288372 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE \`media_basic_info\` ADD CONSTRAINT \`FK_e3125ce0c8214a05954160d8e35\` FOREIGN KEY (\`trailer_id\`) REFERENCES \`trailer\`(\`ID\`) ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
  }
