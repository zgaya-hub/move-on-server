...
export class Review1699555256250 implements MigrationInterface {
  name = 'Review1699555256250';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`ALTER TABLE \`review\` ADD CONSTRAINT \`FK_6b51da2101c9a98ce43a06a1f31\` FOREIGN KEY (\`episode_id\`) REFERENCES \`episode\`(\`ID\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
    await queryRunner.query(`ALTER TABLE \`review\` ADD CONSTRAINT \`FK_c936c3bbfe51a2e87710dfca093\` FOREIGN KEY (\`series_id\`) REFERENCES \`series\`(\`ID\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
