...
export class FinancialInfo1698287339986 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TABLE \`financial_info\` (\`ID\` varchar(36) NOT NULL, \`created_at\` bigint NOT NULL, \`updated_at\` bigint NULL, \`deleted_at\` bigint NULL, \`media_net_profit\` decimal(3,1) NOT NULL DEFAULT '0.0', \`media_budget\` decimal(3,1) NOT NULL DEFAULT '0.0', \`media_revenue\` decimal(3,1) NOT NULL DEFAULT '0.0', \`movie_id\` varchar(36) NULL, \`series_id\` varchar(36) NULL, UNIQUE INDEX \`unique_movie_series\` (\`movie_id\`, \`series_id\`), UNIQUE INDEX \`REL_579357061e6e1f2c6c76a58250\` (\`movie_id\`), UNIQUE INDEX \`REL_874bf2bc5fde4fbd63cb2eca66\` (\`series_id\`), PRIMARY KEY (\`ID\`)) ENGINE=InnoDB`,
    );
    await queryRunner.query(
