...
export class SeasonUpdate1698482134696 implements MigrationInterface {
    name = 'SeasonUpdate1698482134696'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE \`media_basic_info\` (\`ID\` varchar(36) NOT NULL, \`created_at\` bigint NOT NULL, \`updated_at\` bigint NULL, \`deleted_at\` bigint NULL, \`title\` varchar(255) NOT NULL, \`plot_summary\` text NOT NULL, \`release_date\` int NOT NULL, \`movie_id\` varchar(36) NULL, \`series_id\` varchar(36) NULL, \`season_id\` varchar(36) NULL, \`episode_id\` varchar(36) NULL, UNIQUE INDEX \`REL_d12e393362bc829c473bc07b75\` (\`movie_id\`), UNIQUE INDEX \`REL_bd19b3b20b752ebc3ef8c88fbc\` (\`series_id\`), UNIQUE INDEX \`REL_7002d0d05bc530d2302bc714c1\` (\`season_id\`), UNIQUE INDEX \`REL_4c17502a3e6020a2c17262b20e\` (\`episode_id\`), PRIMARY KEY (\`ID\`)) ENGINE=InnoDB`);
