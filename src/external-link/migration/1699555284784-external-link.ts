...
export class ExternalLink1699555284784 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE \`external_link\` ADD CONSTRAINT \`FK_cdc210d45c11b6820f5bb8e2819\` FOREIGN KEY (\`trailer_id\`) REFERENCES \`trailer\`(\`ID\`) ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
  }
