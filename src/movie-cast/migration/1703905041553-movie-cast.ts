...
export class MovieCast1703905041553 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`movie_cast\` ADD CONSTRAINT \`FK_a6c0ed450412f8365639b5a700b\` FOREIGN KEY (\`movie_id\`) REFERENCES \`movie\`(\`ID\`) ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE \`movie_cast\` ADD CONSTRAINT \`FK_6c5b33e50d2e1ca6d8250f25740\` FOREIGN KEY (\`cast_id\`) REFERENCES \`cast\`(\`ID\`) ON DELETE CASCADE ON UPDATE NO ACTION`);
    }
