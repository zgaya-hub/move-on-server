...
export class MovieCast1699555245645 implements MigrationInterface {
  name = 'MovieCast1699555245645';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`ALTER TABLE \`movie_cast\` ADD CONSTRAINT \`FK_a6c0ed450412f8365639b5a700b\` FOREIGN KEY (\`movie_id\`) REFERENCES \`movie\`(\`ID\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
    await queryRunner.query(`ALTER TABLE \`movie_cast\` ADD CONSTRAINT \`FK_6c5b33e50d2e1ca6d8250f25740\` FOREIGN KEY (\`cast_id\`) REFERENCES \`cast\`(\`ID\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
  }
